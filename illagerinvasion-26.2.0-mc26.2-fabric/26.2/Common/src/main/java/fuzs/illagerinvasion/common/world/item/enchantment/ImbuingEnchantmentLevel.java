package fuzs.illagerinvasion.common.world.item.enchantment;
...
public record ImbuingEnchantmentLevel(int enchantmentLevel) {
    ...
    public static boolean isSupportedByImbuing(Holder<Enchantment> enchantment) {
        return DataMapLookup.getData(ModRegistry.IMBUING_LEVELS_DATA_MAP_TYPE, enchantment) != null;
    }

    public static int getImbuingMaxEnchantmentLevel(Holder<Enchantment> enchantment) {
        ImbuingEnchantmentLevel enchantmentLevel = DataMapLookup.getData(ModRegistry.IMBUING_LEVELS_DATA_MAP_TYPE,
                enchantment);
