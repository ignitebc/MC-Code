...
import fuzs.illagerinvasion.common.client.render.entity.state.SpellcasterIllagerRenderState;
import fuzs.illagerinvasion.common.world.entity.monster.Provoker;
...
public class ProvokerRenderer extends IllagerRenderer<Provoker, SpellcasterIllagerRenderState> {
    private static final Identifier TEXTURE_LOCATION = IllagerInvasion.id("textures/entity/provoker.png");
    ...
    @Override
    public Identifier getTextureLocation(SpellcasterIllagerRenderState renderState) {
