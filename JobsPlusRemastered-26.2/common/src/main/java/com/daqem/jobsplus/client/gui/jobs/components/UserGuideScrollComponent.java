...
public class UserGuideScrollComponent extends EmptyComponent
{
    ...
    private static final String USER_GUIDE = """
            ...
            ■ 강화 제작대 이용 방법
            - 강화 제작대에서는 서리빛 네더라이트(네더라이트-다이아) 검, 도구, 방어구를 최대 +10강까지 강화할 수 있습니다.
            ...
            ■ 배고픔
            <red>- 이 서버는 이동·점프·공격·채굴 등 행동으로 소모되는 배고픔이 일반 서버보다 1.5배 빨리 소모됩니다. 식량을 넉넉히 준비하세요.</red>
            ...
            - <red>구매 예약은 한 번 접수되면 직접 취소할 수 없습니다. 예약 전에 종목과 투자금을 신중하게 확인해 주세요.</red>            - 시세 확인이 지연되면 투자금과 예약은 안전하게 유지되며, 확인이 끝날 때까지 같은 종목을 추가 구매하거나 판매할 수 없습니다.
