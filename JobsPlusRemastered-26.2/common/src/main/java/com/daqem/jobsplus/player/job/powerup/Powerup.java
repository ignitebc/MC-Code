...
public class Powerup
{
    ...
    public static final Codec<Powerup> CODEC = RecordCodecBuilder.create(instance -> instance.group(Identifier.CODEC.fieldOf("powerup").forGetter(Powerup::getPowerupLocation), PowerupState.CODEC.fieldOf("state").forGetter(Powerup::getState)
