...
public class ClientTestConfig {
    ...
    public static IConfigEntry<Identifier> testIdentifier;
    ...
    public static void init() {
        ...
        testIdentifier = builder.defineIdentifier("testIdentifier", Identifier.fromNamespaceAndPath("minecraft", "stone"));
        ...
        builder4.defineIdentifier("identifier_entry", Identifier.fromNamespaceAndPath("minecraft", "stone"));
