...
public class IdentifierConfigEntryComponent extends BaseConfigEntryComponent<IdentifierConfigEntry> {

    private final EditBoxWidget editBoxWidget;

    public IdentifierConfigEntryComponent(String key, IdentifierConfigEntry configEntry) {
