...
public abstract class ConfigEntryTypes {
    ...
    public static final IConfigEntryType<IIdentifierConfigEntry, Identifier> IDENTIFIER = register(YamlConfig.getId("identifier"), new IdentifierConfigEntry.Serializer());
    @SuppressWarnings({"rawtypes", "unchecked"})
