...
import com.daqem.yamlconfig.client.gui.component.entry.minecraft.IdentifierConfigEntryComponent;
        ...
        return config.getEntries().entrySet().stream()
                ...
                .map(entry -> {
                    ...
                    return switch (entry) {
                        ...
                        case IdentifierConfigEntry identifierConfigEntry -> new IdentifierConfigEntryComponent(key, identifierConfigEntry);
