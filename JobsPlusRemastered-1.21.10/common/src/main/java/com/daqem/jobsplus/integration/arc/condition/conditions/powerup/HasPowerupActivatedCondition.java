...
public class HasPowerupActivatedCondition extends AbstractCondition
{
    ...
    public static class Serializer implements IConditionSerializer<HasPowerupActivatedCondition>
    {
        ...
        {
            return new HasPowerupActivatedCondition(inverted, getResourceLocation(jsonObject, "powerup"));
        }
        ...
        {
            return new HasPowerupActivatedCondition(inverted, friendlyByteBuf.readResourceLocation());
        }
