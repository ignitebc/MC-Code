...
public class UserGuideScrollComponent extends EmptyComponent
{
    ...
    private static final String USER_GUIDE = """
            ...
            ● 직업 선택권을 손에 들고 우클릭하면
            동시에 보유할 수 있는 최대 직업 수가 1칸 증가합니다.

            ● 서버에서 설정한 최대 직업 수에 도달한 경우에는
            직업 선택권이 사용되지 않으며 아이템도 소모되지 않습니다.

            ● 우클릭을 계속 누르고 있어도 연속으로 사용되지 않도록
            사용 후 약 1초의 대기 시간이 적용됩니다.


            ■ 아이템 이용 제한

            ● 일부 아이템은 직업, 레벨 또는 지정된 조건에 따라
            제작, 제련, 양조, 수리, 마법 부여 및 사용이 제한될 수 있습니다.
            ...
            ● 행동이 제한되면 화면에 제한 사유가 표시됩니다.
            필요한 직업이나 조건을 확인한 후 다시 시도해 주세요.


            ■ 레이드 및 위더 전투 주의사항

            ● 레이드가 진행 중인 지역에서는
            플레이어 주변 80블록 이내의 철 골렘이 즉시 제거됩니다.

            ● 살아 있는 위더가 플레이어 주변 80블록 이내에 있는 경우에도
            주변 80블록 이내의 철 골렘이 즉시 제거됩니다.

            ● 레이드 진행 중 겉날개로 활강하면 즉시 사망합니다.

            ● 살아 있는 위더가 주변 80블록 이내에 있는 상태에서
            겉날개로 활강해도 즉시 사망합니다.

            ● 겉날개를 착용한 것만으로는 사망하지 않습니다.
            실제로 겉날개 활강 상태가 되었을 때 적용됩니다.

            ● 전투 중 겉날개 사용으로 사망하면
            관련 안내 메시지가 서버 전체에 표시됩니다.

            ● 철 골렘과 겉날개를 이용한 전투 우회를 막기 위한 규칙이므로
            레이드와 위더 전투 전 장비를 미리 점검해 주세요.


            ■ 비트코인 계좌

            ● 인벤토리에 보유한 비트코인은
            주식 화면의 입출금 메뉴에서 계좌로 입금할 수 있습니다.

            ● 입금과 출금은 10개 단위로만 가능합니다.

            ● 비트코인을 입금하면 인벤토리에서 해당 수량이 차감되고
            주식 계좌 잔액이 증가합니다.

            ● 비트코인을 출금하면 주식 계좌에서 금액이 차감되고
            인벤토리로 비트코인이 지급됩니다.
            ...
            ● 주식 가격이 상승하면 평가금액이 증가하고,
            주식 가격이 하락하면 평가금액이 감소합니다.

            ● 판매 입력 금액은 현재 평가금액이 아니라
            해당 종목에 투자한 원금을 기준으로 합니다.
            ...
            ● 주식 가격이 상승한 상태라면
            입력한 투자원금보다 실제 판매 금액이 많을 수 있습니다.

            ● 주식 가격이 하락한 상태라면
            입력한 투자원금보다 실제 판매 금액이 적을 수 있습니다.

            ● 주식 판매 시 판매 금액의 0.015%가 수수료로 차감됩니다.

            ● 정상적인 주식 가격을 불러오지 못한 종목은
            가격이 갱신될 때까지 거래할 수 없습니다.
            ...
            ● 신성한 마법부여대는 장비에 적용된 마법 부여를
            기존보다 한 단계 높이는 데 사용합니다.
            ...
            ● 지원하지 않는 마법이나 최대 레벨에 도달한 마법은
            신성한 마법부여대에서 강화할 수 없습니다.


            ■ 잃어버린 양초

            ● 잃어버린 양초를 들고 블록을 우클릭하면
            플레이어 주변 약 8블록 범위의 광물을 탐색합니다.

            ● 주변에서 광물이 발견되면
            발견된 광물의 종류가 화면에 표시되고 전용 소리가 재생됩니다.

            ● 잃어버린 양초는 광물의 정확한 좌표나 방향을 표시하지 않습니다.
            주변에 어떤 광물이 있는지를 확인하는 용도로 사용합니다.
            ...
            ● 시야의 뿔을 사용하면
            플레이어 주변 48블록 이내의 적대적 몬스터가 빛나게 표시됩니다.

            ● 빛나는 효과는 약 3초 동안 유지됩니다.

            ● 벽이나 지형 뒤에 숨어 있는 몬스터의 위치를
            빠르게 확인할 때 사용할 수 있습니다.

            ● 동물이나 일반 주민은 대상에 포함되지 않으며,
            적대적 몬스터에게만 적용됩니다.
            ...
            ● 투명화 상태에서도 장비를 착용하거나 아이템을 들고 있으면
            다른 플레이어에게 일부 모습이 보일 수 있습니다.


            ■ 플래티넘 강화 도끼

            ● 플래티넘 강화 도끼는 일반 근접 무기뿐 아니라
            원거리 투척 무기로도 사용할 수 있습니다.

            ● 사용 버튼을 약 0.5초 이상 누른 후 놓으면
            바라보는 방향으로 도끼를 던집니다.
            ...
            ● 도끼를 던진 동안에는 인벤토리에서 도끼가 사라지므로
            전투가 끝난 후 반드시 회수해 주세요.
            ...
            ● 보상은 인벤토리에 직접 들어오지 않고
            플레이어 주변 바닥에 아이템으로 떨어집니다.

            ● 보상이 용암이나 낭떠러지에 떨어지지 않도록
            안전한 장소에서 랜덤상자를 사용해 주세요.

            ● 여러 묶음으로 나뉜 보상도
            안내 메시지에서는 전체 수량이 합산되어 표시됩니다.
