...
public class UserGuideScrollComponent extends EmptyComponent
{
    ...
    private static final String USER_GUIDE = """
            ...
            ■ 모험에 관하여..
            신규 모험이 업데이트되었습니다. 
            미궁, 일리저 요새, 환영술사 탑, 주술사 오두막, 화염술사 오두막을 찾아 상자 전리품을 찾으세요.
            전리품 - 1단계 ~ 4단계 열쇠, 각종 강화 보상이 추가 되었습니다.

            ■ 엔드시티에 관하여...
            기존 엔드시티와는 차원이 다른 위험이 도사리고 있습니다.
            엔드시티에 갈때는 준비를 단단히 하고 가세요.
