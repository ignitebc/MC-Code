...
public class ActionsPaginationArrowLeftWidget extends CustomButtonWidget
{
    ...
    {
        super(x, y, 10, 10, JobsPlus.translatable("gui.jobs.experience.previous"), new WidgetSprites(JobsPlus.getId("jobs/pagination_arrow_left"), JobsPlus.getId("jobs/pagination_arrow_left_hovered")), button ->
        {
