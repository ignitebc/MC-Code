...
public class TestScrollContentComponent extends TestSpriteComponent {
    ...
    public TestScrollContentComponent(int x, int y, int width, int height) {
        ...
        ButtonWidget buttonWidget1 = new ButtonWidget(10, 10, 160, 20, Component.literal("테스트1"), button -> {
            UILib.LOGGER.info("Test1");
        });
        ButtonWidget buttonWidget2 = new ButtonWidget(10, 40, 160, 20, Component.literal("테스트2"), button -> {
