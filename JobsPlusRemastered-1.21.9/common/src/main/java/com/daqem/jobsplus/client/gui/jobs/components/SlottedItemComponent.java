...
public class SlottedItemComponent extends SpriteComponent
{
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick, int parentWidth, int parentHeight)
    {
        ...
        if (this.parentBounds.get().containsPoint(mouseX, mouseY) && getRectangle().containsPoint(mouseX, mouseY))
        {
            ...
            guiGraphics.setTooltipForNextFrame(minecraft.font, this.itemStack.getTooltipLines(Item.TooltipContext.of(minecraft.level), minecraft.player, TooltipFlag.NORMAL), Optional.empty(), mouseX, mouseY);
        }
    }
