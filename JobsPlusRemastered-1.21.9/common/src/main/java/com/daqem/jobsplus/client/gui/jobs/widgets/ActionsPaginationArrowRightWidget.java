...
public class ActionsPaginationArrowRightWidget extends CustomButtonWidget
{
    ...
    {
        super(x, y, 10, 10, JobsPlus.translatable("gui.jobs.experience.next"), new WidgetSprites(JobsPlus.getId("jobs/pagination_arrow_right"), JobsPlus.getId("jobs/pagination_arrow_right_hovered")), button ->
        {
