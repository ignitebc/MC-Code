...
public class NotCondition extends AbstractCondition {
    ...
    public static class Serializer implements IConditionSerializer<NotCondition> {
        ...
        public NotCondition fromJson(Identifier location, JsonObject jsonObject, boolean inverted) {
            ...
            jsonArray.forEach(jsonElement -> {
                ...
                Identifier type = getResourceLocation(conditionObject, "type");
        ...
        @Override
        public NotCondition fromNetwork(Identifier location, RegistryFriendlyByteBuf friendlyByteBuf, boolean inverted) {
            List<ICondition> tempConditions = new ArrayList<>();
