...
public interface IActionSerializer<T extends IAction> extends ArcSerializer {
    ...
    T fromJson(Identifier location, JsonObject jsonObject, Identifier actionHolderLocation, IActionHolderType<?> actionHolderType, boolean performOnClient, List<IReward> rewards, List<ICondition> conditions);
    ...
    default T fromJson(Identifier location, JsonObject jsonObject) {
        ...
        if (jsonObject.has("rewards")) {
            jsonObject.getAsJsonArray("rewards").forEach(jsonElement -> {
                ...
                Identifier rewardTypeLocation = getResourceLocation(rewardObject, "type");
        ...
        if (jsonObject.has("conditions")) {
            jsonObject.getAsJsonArray("conditions").forEach(jsonElement -> {
                ...
                Identifier conditionTypeLocation = getResourceLocation(conditionObject, "type");
