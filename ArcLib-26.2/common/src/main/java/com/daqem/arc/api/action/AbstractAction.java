...
public abstract class AbstractAction implements IAction {
    ...
    public AbstractAction(Identifier location, Identifier actionHolderLocation, IActionHolderType<?> actionHolderType, boolean performOnClient, List<IReward> rewards, List<ICondition> conditions) {
