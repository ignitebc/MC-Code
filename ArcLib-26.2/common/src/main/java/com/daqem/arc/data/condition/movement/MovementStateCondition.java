...
public class MovementStateCondition extends AbstractCondition
{
    ...
    public static class Serializer implements IConditionSerializer<MovementStateCondition>
    {
        ...
        @Override
        public MovementStateCondition fromJson(Identifier location, JsonObject jsonObject, boolean inverted)
        {
        ...
        @Override
        public MovementStateCondition fromNetwork(Identifier location, RegistryFriendlyByteBuf friendlyByteBuf,
                                                  boolean inverted)
        {
        ...
        private static State parseState(Identifier location, String stateName)
        {
            try
            {
