...
public class HostileEntityCondition extends AbstractCondition
{
    ...
    public static class Serializer implements IConditionSerializer<HostileEntityCondition>
    {
        ...
        @Override
        public HostileEntityCondition fromJson(ResourceLocation location, JsonObject jsonObject, boolean inverted)
        {
            return new HostileEntityCondition(inverted);
        }

        @Override
        public HostileEntityCondition fromNetwork(ResourceLocation location, RegistryFriendlyByteBuf friendlyByteBuf, boolean inverted)
        {
            return new HostileEntityCondition(inverted);
        }
