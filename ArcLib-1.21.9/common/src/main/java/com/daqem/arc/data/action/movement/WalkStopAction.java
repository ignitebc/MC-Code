...
public class WalkStopAction extends AbstractAction {
    ...
    public static class Serializer implements IActionSerializer<WalkStopAction> {
        ...
        @Override
        public WalkStopAction fromNetwork(ResourceLocation location, RegistryFriendlyByteBuf friendlyByteBuf, ResourceLocation actionHolderLocation, IActionHolderType<?> actionHolderType, boolean performOnClient, List<IReward> rewards, List<ICondition> conditions) {
            return new WalkStopAction(location, actionHolderLocation, actionHolderType, performOnClient, rewards, conditions);
        }
