...
public class ModItemTagsProvider extends FabricTagsProvider.ItemTagsProvider
{
    ...
    protected void addTags(HolderLookup.Provider arg)
    {
        ...
        tag(ModTags.NETHERITE_BLOCKITEMS)
                ...
                .add(ModItems.SOLAR_BLOCK.builtInRegistryHolder().key())
        ...
        tag(ModTags.NETHERITE_INGOTS)
                ...
                .add(ModItems.SOLAR_INGOT.builtInRegistryHolder().key())
        ...
        tag(ModTags.UPGRADE_TO_SOLAR).addTag(ModTags.INGOTS_NETHERITES_GOLD);
        ...
        tag(ModTags.INGOTS_NETHERITES_GOLD).add(ModItems.SOLAR_INGOT.builtInRegistryHolder().key());
        ...
        tag(ModTags.INGOTS_UPGRADE_TO_SOLAR).addTag(ModTags.INGOTS_NETHERITES_IRON);
        ...
        tag(ModTags.AXE_SOLAR).add(ModItems.SOLAR_AXE.builtInRegistryHolder().key());
        ...
        tag(ModTags.AXE_UPGRADE_TO_SOLAR).addTag(ModTags.AXE_ASH);
        tag(ModTags.AXE_UPGRADE_TO_SOUL).addTag(ModTags.AXE_SOLAR);
        ...
        tag(ModTags.HOE_SOLAR).add(ModItems.SOLAR_HOE.builtInRegistryHolder().key());
        ...
        tag(ModTags.HOE_UPGRADE_TO_SOLAR).addTag(ModTags.HOE_ASH);
        tag(ModTags.HOE_UPGRADE_TO_SOUL).addTag(ModTags.HOE_SOLAR);
        ...
        tag(ModTags.PICKAXE_SOLAR).add(ModItems.SOLAR_PICKAXE.builtInRegistryHolder().key());
        ...
        tag(ModTags.PICKAXE_UPGRADE_TO_SOLAR).addTag(ModTags.PICKAXE_ASH);
        tag(ModTags.PICKAXE_UPGRADE_TO_SOUL).addTag(ModTags.PICKAXE_SOLAR);
        ...
        tag(ModTags.SHOVEL_SOLAR).add(ModItems.SOLAR_SHOVEL.builtInRegistryHolder().key());
        ...
        tag(ModTags.SHOVEL_UPGRADE_TO_SOLAR).addTag(ModTags.SHOVEL_ASH);
        tag(ModTags.SHOVEL_UPGRADE_TO_SOUL).addTag(ModTags.SHOVEL_SOLAR);
        ...
        tag(ModTags.SWORD_SOLAR).add(ModItems.SOLAR_SWORD.builtInRegistryHolder().key());
        ...
        tag(ModTags.SWORD_UPGRADE_TO_SOLAR).addTag(ModTags.SWORD_ASH);
        tag(ModTags.SWORD_UPGRADE_TO_SOUL).addTag(ModTags.SWORD_SOLAR);
        ...
        tag(ModTags.SPEAR_SOLAR).add(ModItems.SOLAR_SPEAR.builtInRegistryHolder().key());
        ...
        tag(ModTags.SPEAR_UPGRADE_TO_SOLAR).addTag(ModTags.SPEAR_ASH);
        tag(ModTags.SPEAR_UPGRADE_TO_SOUL).addTag(ModTags.SPEAR_SOLAR);
        ...
        tag(ModTags.HELMET_SOLAR).add(ModItems.SOLAR_HELMET.builtInRegistryHolder().key());
        ...
        tag(ModTags.HELMET_UPGRADE_TO_SOLAR).addTag(ModTags.HELMET_ASH);
        tag(ModTags.HELMET_UPGRADE_TO_SOUL).addTag(ModTags.HELMET_SOLAR);
        ...
        tag(ModTags.CHESTPLATE_SOLAR).add(ModItems.SOLAR_CHESTPLATE.builtInRegistryHolder().key());
        ...
        tag(ModTags.CHESTPLATE_UPGRADE_TO_SOLAR).addTag(ModTags.CHESTPLATE_ASH);
        tag(ModTags.CHESTPLATE_UPGRADE_TO_SOUL).addTag(ModTags.CHESTPLATE_SOLAR);
        ...
        tag(ModTags.LEGGINGS_SOLAR).add(ModItems.SOLAR_LEGGINGS.builtInRegistryHolder().key());
        ...
        tag(ModTags.LEGGINGS_UPGRADE_TO_SOLAR).addTag(ModTags.LEGGINGS_ASH);
        tag(ModTags.LEGGINGS_UPGRADE_TO_SOUL).addTag(ModTags.LEGGINGS_SOLAR);
        ...
        tag(ModTags.BOOTS_SOLAR).add(ModItems.SOLAR_BOOTS.builtInRegistryHolder().key());
        ...
        tag(ModTags.BOOTS_UPGRADE_TO_SOLAR).addTag(ModTags.BOOTS_ASH);
        tag(ModTags.BOOTS_UPGRADE_TO_SOUL).addTag(ModTags.BOOTS_SOLAR);
        tag(ModTags.BOOTS_UPGRADE_TO_FROST).addTag(ModTags.BOOTS_SOUL);

        // tiers
        tag(ModTags.TIER_ARMOR)
                .addTag(ModTags.TIER_ARMOR_ASH)
                .addTag(ModTags.TIER_ARMOR_SOLAR)
        ...
        tag(ModTags.TIER_ARMOR_SOLAR)
                .add(ModItems.SOLAR_HELMET.builtInRegistryHolder().key())
                .add(ModItems.SOLAR_CHESTPLATE.builtInRegistryHolder().key())
                .add(ModItems.SOLAR_LEGGINGS.builtInRegistryHolder().key())
                .add(ModItems.SOLAR_BOOTS.builtInRegistryHolder().key());
        ...
        tag(ModTags.TIER_TOOLS)
                ...
                .addTag(ModTags.TIER_TOOL_SOLAR)
        ...
        tag(ModTags.TIER_TOOL_SOLAR)
                .add(ModItems.SOLAR_AXE.builtInRegistryHolder().key())
                .add(ModItems.SOLAR_HOE.builtInRegistryHolder().key())
                .add(ModItems.SOLAR_PICKAXE.builtInRegistryHolder().key())
                .add(ModItems.SOLAR_SHOVEL.builtInRegistryHolder().key())
                .add(ModItems.SOLAR_SWORD.builtInRegistryHolder().key());
        ...
        tag(ModTags.REPAIRS_ASH_ARMOR)
                .add(ModItems.ASH_INGOT.builtInRegistryHolder().key());
        tag(ModTags.REPAIRS_SOLAR_ARMOR)
                .add(ModItems.SOLAR_INGOT.builtInRegistryHolder().key());
        ...
        tag(ModTags.REPAIRS_ASH_TOOLS)
                .add(ModItems.ASH_INGOT.builtInRegistryHolder().key());
        tag(ModTags.REPAIRS_SOLAR_TOOLS)
                .add(ModItems.SOLAR_INGOT.builtInRegistryHolder().key());
        ...
        tag(ItemTags.PIGLIN_LOVED)
                ...
                .add(ModItems.SOLAR_SHOVEL.builtInRegistryHolder().key())
                .add(ModItems.SOLAR_SWORD.builtInRegistryHolder().key())
                .add(ModItems.SOLAR_SPEAR.builtInRegistryHolder().key());
